...
class FakePsfexPsfDeterminerConfig(pexConfig.Config):
...
class FakePsfexPsfDeterminer(object):
    ConfigClass = FakePsfexPsfDeterminerConfig

    def __init__(self, config):
        """
        @param[in] config: instance of FakePsfexPsfDeterminerConfig
        """
        self.config = config
...
psfDeterminerRegistry.register("fakePsfex", FakePsfexPsfDeterminer)
